...
export function Install({ bot }: { bot: Bot }) {
  ...
  // Points at ck-cdn, not at ck-api — the API Worker serves only the
  // API and has no /widget.js route. WIDGET_SRC is the major-pinned
  // path (/v1/widget.js): a tenant who pastes this gets fixes without
  // asking and breaking changes never.
  //
